...
salaries.2014 <- runif(100, min = 5000, max = 20000)

# Create a vector of 2015 salaries that are typically higher than the 2014 salaires (use runif again)
salaries.2015 <- salaries.2014 + runif(100, min = -1500, max = 5000)
...
# How many employees got a raise?
  # salaries[salaries$got.raise == TRUE,] This gives  
  # a dataframe that has all the rows that got a raise
  # OR
